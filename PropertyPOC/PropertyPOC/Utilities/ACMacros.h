...
#define TabBar_Height           ((IS_IPHONE_X==YES)?83.0f: 49.0f)
#define Cell_bottomLineX        55
...
//CGSizeEqualToSize(CGSizeMake(1125, 2536), \
//[[UIScreen mainScreen] currentMode].size) : \
//NO)

#define IS_IPHONE_X (Main_Screen_Width == 375.f && Main_Screen_Height == 812.f)
...
#ifdef ITTDEBUG
#define ITTDPRINT(xx, ...)      DLog(@"< %s:(%d) > : " xx , __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)
#else
