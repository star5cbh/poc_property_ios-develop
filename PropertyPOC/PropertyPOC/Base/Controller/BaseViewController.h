...
@property (nonatomic, assign) NoNetShowType noNetType;
//
//@property (nonatomic, strong) TopNotiView *topNoti;
//
//@property (nonatomic, strong) NoConnectView *noConnectView;

- (BOOL)checkNetConnection;

- (BOOL)checkNetConnectionShowHint;
