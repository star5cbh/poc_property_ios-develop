...
#define DATE_COMPONENTS (NSCalendarUnitYear| NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekOfMonth |  NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitWeekOfMonth | NSCalendarUnitWeekday | NSCalendarUnitWeekdayOrdinal)
...
- (NSString *)formattedDateDescriptionToDay
{
...
/*格式化日期描述*/
- (NSString *)formattedDateDescriptionToSecond
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
...
- (NSString *)formattedDateDescriptionToMilSecond
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
...
/*格式化日期描述*/
- (NSString *)formattedHoursDescriptionToSecond
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
